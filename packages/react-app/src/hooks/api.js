...
export const COMMUNITY_QUERY = gql`
  ...
  ${CommunityFields}
`;
export const GET_FK_POSTS = gql`
  query Publications {
    publications(request: { profileIdPointed: "0x6b36-0x41", publicationTypes: [COMMENT], limit: 10 }) {
      items {
        __typename
        ... on Post {
          ...PostFields
...
export const GET_FK = gql`
  query Publication {
    publication(request: { publicationId: "0x6b36-0x42" }) {
      __typename
      ... on Post {
        ...PostFields
      }
